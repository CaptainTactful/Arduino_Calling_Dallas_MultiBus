...
void loop(void)
{
  ...
  Serial.println("");
    ...
    sensor_busone.requestTemperatures();
            ...
            printAddress(add1A);
            Serial.print("   ");
    Serial.println(sensor_busone.getTempCByIndex(0)*100+3000);
    delay(500);
            Serial.print("Bus 1B: ");
            printAddress(add1B);
            Serial.print("   ");
    Serial.println(sensor_busone.getTempCByIndex(1)*100+3000);
    delay(500);
            Serial.print("Bus 1C: ");
            printAddress(add1C);
            Serial.print("   ");
    Serial.println(sensor_busone.getTempCByIndex(2)*100+3000);
    delay(500);
            Serial.print("Bus 1D: ");
            printAddress(add1D);
            Serial.print("   ");
    Serial.println(sensor_busone.getTempCByIndex(3)*100+3000);
    delay(500);
            Serial.print("Bus 1E: ");
            printAddress(add1E);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(4)*100+3000);
    delay(500);
            Serial.print("Bus 1F: ");
            printAddress(add1F);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(5)*100+3000);
    delay(500);
            Serial.print("Bus 1G: ");
            printAddress(add1G);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(6)*100+3000);
    delay(500);
            Serial.print("Bus 1H: ");
            printAddress(add1H);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(7)*100+3000);
    delay(500);
            Serial.print("Bus 1I: ");
            printAddress(add1I);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(8)*100+3000);
    delay(500);
            Serial.print("Bus 1J: ");
            printAddress(add1J);
            Serial.print("   ");            
    Serial.println(sensor_busone.getTempCByIndex(9)*100+3000);
    delay(500);
    ...
    sensor_bustwo.requestTemperatures();
            ...
            printAddress(add2A);
            Serial.print("   ");
    Serial.println(sensor_bustwo.getTempCByIndex(0)*100+3000);
    delay(500);
            Serial.print("Bus 2B: ");
            printAddress(add2B);
            Serial.print("   ");
    Serial.println(sensor_bustwo.getTempCByIndex(1)*100+3000);
    delay(500);
            Serial.print("Bus 2C: ");
            printAddress(add2C);
            Serial.print("   ");
    Serial.println(sensor_bustwo.getTempCByIndex(2)*100+3000);
    delay(500);
            Serial.print("Bus 2D: ");
            printAddress(add2D);
            Serial.print("   ");
    Serial.println(sensor_bustwo.getTempCByIndex(3)*100+3000);
    delay(500);
            Serial.print("Bus 2E: ");
            printAddress(add2E);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(4)*100+3000);
    delay(500);
            Serial.print("Bus 2F: ");
            printAddress(add2F);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(5)*100+3000);
    delay(500);
            Serial.print("Bus 2G: ");
            printAddress(add2G);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(6)*100+3000);
    delay(500);
            Serial.print("Bus 2H: ");
            printAddress(add2H);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(7)*100+3000);
    delay(500);
            Serial.print("Bus 2I: ");
            printAddress(add2I);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(8)*100+3000);
    delay(500);
            Serial.print("Bus 2J: ");
            printAddress(add2J);
            Serial.print("   ");            
    Serial.println(sensor_bustwo.getTempCByIndex(9)*100+3000);
    delay(500);
    ...
    sensor_busthree.requestTemperatures();
            ...
            printAddress(add3A);
            Serial.print("   ");
    Serial.println(sensor_busthree.getTempCByIndex(0)*100+3000);
    delay(500);
            Serial.print("Bus 3B: ");
            printAddress(add3B);
            Serial.print("   ");
    Serial.println(sensor_busthree.getTempCByIndex(1)*100+3000);
    delay(500);
            Serial.print("Bus 3C: ");
            printAddress(add3C);
            Serial.print("   ");
    Serial.println(sensor_busthree.getTempCByIndex(2)*100+3000);
    delay(500);
            Serial.print("Bus 3D: ");
            printAddress(add3D);
            Serial.print("   ");
    Serial.println(sensor_busthree.getTempCByIndex(3)*100+3000);
    delay(500);
            Serial.print("Bus 3E: ");
            printAddress(add3E);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(4)*100+3000);
    delay(500);
            Serial.print("Bus 3F: ");
            printAddress(add3F);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(5)*100+3000);
    delay(500);
            Serial.print("Bus 3G: ");
            printAddress(add3G);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(6)*100+3000);
    delay(500);
            Serial.print("Bus 3H: ");
            printAddress(add3H);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(7)*100+3000);
    delay(500);
            Serial.print("Bus 3I: ");
            printAddress(add3I);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(8)*100+3000);
    delay(500);
            Serial.print("Bus 3J: ");
            printAddress(add3J);
            Serial.print("   ");            
    Serial.println(sensor_busthree.getTempCByIndex(9)*100+3000);
    delay(500);
    ...
    sensor_busfour.requestTemperatures();
        Serial.print("Bus 4A: ");
            printAddress(add4A);
            Serial.print("   ");        
    Serial.println(sensor_busfour.getTempCByIndex(0)*100+3000);
    delay(500);
            Serial.print("Bus 4B: ");
            printAddress(add4B);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(1)*100+3000);
    delay(500);
            Serial.print("Bus 4C: ");
            printAddress(add4C);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(2)*100+3000);
    delay(500);
            Serial.print("Bus 4D: ");
            printAddress(add4D);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(3)*100+3000);
    delay(500);
            Serial.print("Bus 4E: ");
            printAddress(add4E);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(4)*100+3000);
    delay(500);
            Serial.print("Bus 4F: ");
            printAddress(add4F);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(5)*100+3000);
    delay(500);
            Serial.print("Bus 4G: ");
            printAddress(add4G);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(6)*100+3000);
    delay(500);
            Serial.print("Bus 4H: ");
            printAddress(add4H);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(7)*100+3000);
    delay(500);    
            Serial.print("Bus 4I: ");
            printAddress(add4I);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(8)*100+3000);
    delay(500);    
            Serial.print("Bus 4J: ");
            printAddress(add4J);
            Serial.print("   ");            
    Serial.println(sensor_busfour.getTempCByIndex(9)*100+3000);            
    delay(2000);
}
